          ...
          <div class="card card-outline card-primary">
            <div class="card-header">
              ...
              <a class="btn btn-xs bg-info" href="/request_hr?status=1&type=3" style="font-size: 0.85rem;">
                ...
                <span class="badge badge-light">{{ @$viewShare['ge_approval'] }}</span>
              </a>
          ...
          <div class="card">
            <div class="card-header card-header-primary">
              ...
              <div class="text-right">
                <a href="{{ route('request_hr.create') }}" class="btn btn-sm btn-success">{{ __('Create') }}</a>
              </div>
            </div>
              ...
              <table class="table table-striped">
                ...
                @foreach($data as $key => $item)
                  <tr>
                    <td> {{ $i++ }}</td>
                    <td class="td-actions">
                        @include('request_hr.list_action', ['uri' => 'request_hr', 'object' => $item])
                    </td>
