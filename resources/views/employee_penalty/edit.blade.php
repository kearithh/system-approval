            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <form
                        ...
                        action="{{ route('employee_penalty.update', $data->id) }}"
                        class="form-horizontal">
                        @csrf
                        <div class="card ">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title">កែប្រែសំណើសុំទទួលប្រាក់ពិន័យបុគ្គលិក</h4>
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group{{ $errors->has('subject') ? ' has-danger' : '' }}">
                                            <textarea
                                                ...
                                                name="subject"
                                                required
                                            >@if($data){{ $data->subject }}@else{{ old('subject') }}@endif
                                            </textarea>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group{{ $errors->has('purpose') ? ' has-danger' : '' }}">
                                            <input type="text" class="form-control" name="staff" required
                                                    value="{{ @(\App\EmployeePenalty::staffName($data->id)->name) }}">
                                        </div>
                                    </div>
                                </div>

                                @include('employee_penalty.partials.item_table_edit')

                                @include('employee_penalty.partials.item_table_customer_edit')
