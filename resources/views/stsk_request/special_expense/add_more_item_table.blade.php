<div class="table-responsive">
    <table id="sections" class="table table-hover" style="display: block; overflow-y: auto">
        ...
        <th style="min-width: 350px">ឈ្មោះ</th>
        <th style="min-width: 300px">បរិយាយ</th>
        <th style="min-width: 120px">បរិមាណ</th>
        <th style="min-width: 80px">រូបិយប័ណ្ណ</th>
        <th style="min-width: 150px">ថ្លៃឯកត្តា</th>
        <th style="min-width: 120px">ពន្ធ(%)</th>
        ...
        <tr class="section">
            ...
            <td>
                <select required class="col-sm-12 currency" style="height: 30px" name="currency[]" id="">
                    <option value="">----</option>
                    <option value="KHR" @if(\Illuminate\Support\Facades\Auth::user()->branch_id) selected @endif>រៀល</option>
