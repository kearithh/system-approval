...
<!-- <div class="signature"> -->
    <div class="col-md-3">
        ...
        <p class="requester-name">{{ @$data->creator_object->name ?: $data->requester->name }}</p><br>
    </div>
            ...
            <div class="col-md-3">
                @if($reviewers[$i]->approve_status == $approve)
                    ...
                    @if(@$data->company_id == 2) <!-- MFI -->
                        @if (@$reviewers[$i]->id == 543) <!-- sinlangche -->
                            <span>ប្រធាននាយកដ្ឋានធនធានមនុស្ស និងរដ្ឋបាល</span><br>
                        @else
                    ...
                    <p>{{ @json_decode($reviewers[$i]->user_object)->name ?: $reviewers[$i]->name }}</p><br>
                @else
