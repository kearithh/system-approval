                    ...
                    <tr>
                        <td>
                            <input 
                                ...
                                value="{{ @$subject_obj->interest_past }}"
                                required
                            >
                        </td>
                        <td>
                            <select required style="height: 30px; width: 150px;" name="subject_obj[type_loan]">
                                <option value="">----</option>
                                <option value="1" @if(@$subject_obj->type_loan == '1') selected @endif>
                                    អតិថិជនយឺតយ៉ាវ (Loan Default)
                                </option>
                                <option value="2" @if(@$subject_obj->type_loan == '2') selected @endif>
                        ...
                        <td>
                            <input 
                                ...
                                value="{{ @$subject_obj->customer_name }}"
                                required
                            >
                        </td>
                        <td>
                            <select required style="height: 30px; width: 70px;" name="subject_obj[gender]">
                                <option value="">----</option>
                                <option value="M" @if(@$subject_obj->gender == 'M') selected @endif>ប្រុស</option>
                                <option value="F" @if(@$subject_obj->gender == 'F') selected @endif>ស្រី</option>
                            </select>
                        </td>
                        <td>
                            <input
                        ...
                        <td>
                            <input
                                ...
                                value="{{ @$subject_obj->number_day_late }}"
                                required
                            >
                        </td>
                    </tr>
