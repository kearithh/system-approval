      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <form
                  ...
                  action="{{ route('mission_clearance.update', $data->id) }}"
            ...
            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">{{ __('កែប្រែទម្រង់ជម្រះបេសកកម្ម') }}</h4>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <small><i>អ្នកស្នើសុំ ត្រូវបំពេញដោយការទទួលខុសត្រូវ | Requestor should fill in this request properly.</i></small>
                        @include('mission_clearance.partials.edit_item_table')
                    </div>
                    <div class="col-sm-12">
                        <div class="row">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-9">
                                <select required class="form-control receiver select2" name="receiver">
                                    ...
                                    @foreach($staffs as $item)
                                        <option 
                                            value="{{ $item->id }}" 
                                            @if($item->id == @$data->receiver) selected @endif
                                        >
                                            {{ $item->name }}
                                        </option>
                                    @endforeach
