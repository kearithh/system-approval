@extends('layouts.reference', ['activePage' => 'position', 'titlePage' => __('Create Position')])
          ...
          <form
            ...
            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">{{ __('Create Position') }}</h4>
                <div class="text-right">
                  <a href="{{ route('position.index') }}" class="btn btn-sm btn-success">{{ __('Back to list') }}</a>
                </div>
              </div>
              <div class="card-body ">
                <div class="row">
                  <label class="col-sm-2 col-form-label">{{ __('ឈ្មោះកាត់') }}</label>
                  <div class="col-sm-7">
                ...
                <div class="row">
                  <label class="col-sm-2 col-form-label">{{ __('ឈ្មោះ(KM)') }}</label>
                  <div class="col-sm-7">
                ...
                <div class="row">
                  <label class="col-sm-2 col-form-label">{{ __('ឈ្មោះ(EN)') }}</label>
                  <div class="col-sm-7">
                ...
                <div class="row">
                  <label class="col-sm-2 col-form-label">{{ __('លំដាប់') }}</label>
                  <div class="col-sm-7">
