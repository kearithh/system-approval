                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h4 class="card-title ">{{ __('Disposal List') }}</h4>
                            <div class="text-right">
                                <a href="{{ route('disposal.create') }}" class="btn btn-sm btn-success">{{ __('Create') }}</a>
                            </div>
                        </div>
                            ...
                            <table class="table table-striped">
                                ...
                                @foreach($data as $key => $item)
                                    <tr>
                                        <td> {{ $i++ }}</td>
                                        <td class="td-actions">
                                            @include('global.list_action', ['uri' => 'disposal', 'object' => $item])
                                        </td>
