        ...
        <div class="col-md-12">
            ...
            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">{{ __('ទម្រង់បុរេប្រទាន') }}</h4>
              ...
              <form 
                        ...
                        id="requestForm"
                        method="POST"
                        action="{{ route('cash_advance.store') }}"
                ...
                <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 form-group">
                                <select class="form-control" name="type">
                                    <option value="1">បេសកម្មធ្វើដំណើរ</option>
                                    <option value="2" >ផ្សេងៗ</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="row">
                            ...
                            <div class="col-md-9 form-group">
                                <select class="form-control" id="type_advance" name="type_advance">
                                    <option value="{{ config('app.advance') }}">បុរេប្រទាន (Advance)</option>
                                    <option value="{{ config('app.clear_advance') }}">ជម្រះបុរេប្រទាន (Clear Advance)</option>
                                    <option value="{{ config('app.reimbursement') }}">ទម្រង់ទូទាត់ការចំណាយ (Reimbursement)</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        @include('cash_advance.partials.item_table')
                    </div>
                    ...
                    <div class="col-sm-12 form_clear">
                        <div class="row">
                            ...
                            <div class="col-md-9 form-group">
                                <input class="form-control clear_advacne" type="number" id="advance" name="advance_obj[advance]" autocomplete="off">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 form_clear">
                        <div class="row">
                            ...
                            <div class="col-md-9 form-group">
                                <input class="form-control clear_advacne" type="number" readonly id="expense" name="advance_obj[expense]" autocomplete="off">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 form_clear">
                        <div class="row">
                            ...
                            <div class="col-md-9 form-group">
                                <input class="form-control clear_advacne" type="number" readonly id="company" name="advance_obj[company]" autocomplete="off">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 form_clear">
                        <div class="row">
                            ...
                            <div class="col-md-9 form-group">
                                <input class="form-control clear_advacne" type="number" readonly id="staff" name="advance_obj[staff]" autocomplete="off">
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-9">
                                <div class="form-group{{ $errors->has('note') ? ' has-danger' : '' }}">
                                    <textarea
                                            ...
                                            name="note"
                                    >បុរេប្រទាននេះ ត្រូវធ្វើការជម្រះរៀងរាល់ថ្ងៃច័ន្ទ បន្ទាប់ពីបញ្ចប់បេសកម្ម ឬទទួលបានឯកសារគ្រប់គ្រាន់ ។</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 mb-3">
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9 form-group">
                                    <select class="form-control js-approver" required readonly="true" name="approver_id" required>
