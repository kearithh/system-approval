          ...
          <form
            ...
            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">{{ __('Update Password') }}</h4>
                  <div class="text-right">
                    <a href="{{ route('user.edit', Auth::id()) }}" class="btn btn-sm btn-success">
                      {{ __('Profile') }}
                    </a>
                  </div>
              </div>
              <div class="card-body ">
                ...
                @endif
                <div class="row">
                  <label class="col-sm-2 col-form-label" for="input-current-password">{{ __(' លេខសំងាត់បច្ចុប្បន្ន') }}</label>
                  <div class="col-sm-7">
