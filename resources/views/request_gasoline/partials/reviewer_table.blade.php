<div id="reviewer" style="padding: 15px; margin-bottom: 5px">
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <th style="min-width: 70px;" class="text-center">ព្រម<br>Approved</th>
            <th style="min-width: 70px;" class="text-center">មិនព្រម<br>Disapproved</th>
    ...
    @if($data->link)
        ...
        <a href="{{ route('cash_advance.show', @$data->link) }}" target="_blank">
          <mark id="highlights"> Cash Advance </mark>
        </a><br>
    @endif
