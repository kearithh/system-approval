<div class="form-group">
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="finance[cash_manage]" id="cash_manage_do" value="1" 
            @if(@$data->finance->cash_manage == 1) checked @endif>
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="finance[cash_manage]" id="cash_manage_not_do" value="2"
            @if(@$data->finance->cash_manage == 2) checked @endif>
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="finance[cash_manage]" id="cash_manage_problem" value="3"
            @if(@$data->finance->cash_manage == 3) checked @endif>
  ...
  <div>
    ...
    >{{ @$data->finance->cash_manage_node }}</textarea>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="finance[cash_manage_doc]" id="cash_manage_doc_do" value="1" 
            @if(@$data->finance->cash_manage_doc == 1) checked @endif>
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="finance[cash_manage_doc]" id="cash_manage_doc_not_do" value="2"
            @if(@$data->finance->cash_manage_doc == 2) checked @endif>
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="finance[cash_manage_doc]" id="cash_manage_doc_problem" value="3"
            @if(@$data->finance->cash_manage_doc == 3) checked @endif>
  ...
  <div>
    ...
    >{{ @$data->finance->cash_manage_doc_node }}</textarea>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="finance[daily_cash]" id="daily_cash_have" value="1" 
            @if(@$data->finance->daily_cash == 1) checked @endif>
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="finance[daily_cash]" id="daily_cash_not_have" value="2"
            @if(@$data->finance->daily_cash == 2) checked @endif>
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="finance[daily_cash]" id="daily_cash_problem" value="3"
            @if(@$data->finance->daily_cash == 3) checked @endif>
  ...
  <div>
    ...
    >{{ @$data->finance->daily_cash_node }}</textarea>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="finance[approve_expense]" id="approve_expense_do" value="1" 
            @if(@$data->finance->approve_expense == 1) checked @endif>
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="finance[approve_expense]" id="approve_expense_not_do" value="2"
            @if(@$data->finance->approve_expense == 2) checked @endif>
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="finance[approve_expense]" id="approve_expense_problem" value="3"
            @if(@$data->finance->approve_expense == 3) checked @endif>
  ...
  <div>
    ...
    >{{ @$data->finance->approve_expense_node }}</textarea>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="finance[check_mb]" id="check_mb_do" value="1" 
            @if(@$data->finance->check_mb == 1) checked @endif>
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="finance[check_mb]" id="check_mb_not_do" value="2"
            @if(@$data->finance->check_mb == 2) checked @endif>
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="finance[check_mb]" id="check_mb_problem" value="3"
            @if(@$data->finance->check_mb == 3) checked @endif>
  ...
  <div>
    ...
    >{{ @$data->finance->check_mb_node }}</textarea>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="finance[check_wo]" id="check_wo_do" value="1" 
            @if(@$data->finance->check_wo == 1) checked @endif>
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="finance[check_wo]" id="check_wo_not_do" value="2"
            @if(@$data->finance->check_wo == 2) checked @endif>
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="finance[check_wo]" id="check_wo_problem" value="3"
            @if(@$data->finance->check_wo == 3) checked @endif>
  ...
  <div>
    ...
    >{{ @$data->finance->check_wo_node }}</textarea>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="finance[cash_bank]" id="cash_bank_do" value="1" 
            @if(@$data->finance->cash_bank == 1) checked @endif>
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="finance[cash_bank]" id="cash_bank_not_do" value="2"
            @if(@$data->finance->cash_bank == 2) checked @endif>
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="finance[cash_bank]" id="cash_bank_problem" value="3"
            @if(@$data->finance->cash_bank == 3) checked @endif>
  ...
  <div>
    ...
    >{{ @$data->finance->cash_bank_node }}</textarea>
  </div>
</div>
