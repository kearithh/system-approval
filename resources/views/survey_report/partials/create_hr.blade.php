<div class="form-group">
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="hr[date_staff]" id="date_staff_do" value="1" checked>
...
<div class="form-group">
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="hr[staff_lack]" id="staff_lack_do" value="1" checked>
...
<div class="form-group">
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="hr[home_visit]" id="home_visit_do" value="1" checked>
...
<div class="form-group">
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="hr[violate_contract]" id="violate_contract_do" value="1" checked>
