            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <form
                        ...
                        action="{{ route('request_po.update', $data->id) }}"
                        class="form-horizontal">
                        @csrf
                        <input type="hidden" class="request_token" name="request_token" value="{{ encrypt($data->id) }}">
                        <div class="card ">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title">{{ __('កែប្រែបណ្ណបញ្ជាទិញ​/Purchase Order') }}</h4>
                                <p class="card-category"></p>
                            </div>
                            <div class="card-body ">
                                @include('request_po.add_more_item_table_edit')
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-group{{ $errors->has('code_pr') ? ' has-danger' : '' }}">
                                            <select required class="form-control company select2" name="code_pr[]" multiple>
                                                <option value=""> << ជ្រើសរើស >> </option>
                                                @foreach($requestPR as $key => $value)
                                                    <option value="{{ $value->code }}"
                                                            @if(is_array($data->code_pr) && in_array($value->id, $data->code_pr))
                                                                selected
                                                            @endif
                                                    >
                                                        {{ $value->code }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-group{{ $errors->has('exchange_rate') ? ' has-danger' : '' }}">
                                            ...
                                            >@if($data){{ $data->exchange_rate }}@else{{ old('exchange_rate') }}@endif
                                            </textarea>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-group{{ $errors->has('vat') ? ' has-danger' : '' }}">
                                            <textarea style="width: 100%; height: 40px"
                                                ...
                                                required
                                                oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                                            >@if($data){{ $data->vat }}@else{{ old('vat') }}@endif
                                            </textarea>
                                            @if ($errors->has('vat'))
                                    ...
                                    <div class="col-sm-">
                                        <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                            <textarea
                                                ...
                                                name="email"
                                            >@if($data){{ $data->email }}@else{{ old('email') }}@endif
                                            </textarea>
                                            @if ($errors->has('email'))
                                    ...
                                    <div class="col-sm-">
                                        <div class="form-group{{ $errors->has('vat_vd') ? ' has-danger' : '' }}">
                                            <textarea
                                                ...
                                                name="vat_vd"
                                            >@if($data){{ $data->vat_vd }}@else{{ old('vat_vd') }}@endif
                                            </textarea>
                                ...
                                <div class="form-group{{ $errors->has('ord_one') ? ' has-danger' : '' }}">
                                            ...
                                            >@if($data){{ $data->ord_one }}@else{{ old('ord_one') }}@endif
                                            </textarea>
                                ...
                                <div class="form-group{{ $errors->has('ord_two') ? ' has-danger' : '' }}">
                                            ...
                                            >@if($data){{ $data->ord_two }}@else{{ old('ord_two') }}@endif
                                            </textarea>
                                ...
                                <div class="form-group{{ $errors->has('orchid') ? ' has-danger' : '' }}">
                                            ...
                                            >@if($data){{ $data->orchid }}@else{{ old('orchid') }}@endif
                                            </textarea>
                                ...
                                <div class="form-group{{ $errors->has('spine') ? ' has-danger' : '' }}">
                                            ...
                                            >@if($data){{ $data->spine }}@else{{ old('spine') }}@endif
                                            </textarea>
                                            @if ($errors->has('spine'))
                                ...
                                <div class="form-group{{ $errors->has('incoterm') ? ' has-danger' : '' }}">
                                            <textarea style="width: 100%; height: 40px" placeholder="1.incoterm:"
                                                ...
                                                name="incoterm"                                               
                                            >@if($data){{ $data->incoterm }}@else{{ old('incoterm') }}@endif
                                            </textarea>
                                ...
                                <div class="form-group{{ $errors->has('payment') ? ' has-danger' : '' }}">
                                            <textarea style="width: 100%; height: 40px" placeholder="2.payment:"
                                                ...
                                                name="payment"
                                            >@if($data){{ $data->payment }}@else{{ old('payment') }}@endif
                                            </textarea>
                                ...
                                <div class="form-group{{ $errors->has('delivery') ? ' has-danger' : '' }}">
                                            <textarea style="width: 100%; height: 40px" placeholder="3.delivery: "
                                                ...
                                                name="delivery"
                                            >@if($data){{ $data->delivery }}@else{{ old('delivery') }}@endif
                                            </textarea>
                                ...
                                <div class="form-group{{ $errors->has('shipment') ? ' has-danger' : '' }}">
                                            <textarea style="width: 100%; height: 40px" placeholder="4.shipment:  "
                                                ...
                                                name="shipment"
                                            >@if($data){{ $data->shipment }}@else{{ old('shipment') }}@endif
                                            </textarea>
                                ...
                                <div class="form-group{{ $errors->has('warranty') ? ' has-danger' : '' }}">
                                            <textarea style="width: 100%; height: 40px" placeholder="5.warranty:"
                                                ...
                                                name="warranty"
                                            >@if($data){{ $data->warranty }}@else{{ old('warranty') }}@endif
                                            </textarea>
                                ...
                                <div class="form-group{{ $errors->has('consignee') ? ' has-danger' : '' }}">
                                            <textarea style="width: 100%; height: 40px" placeholder="6.consignee: "
                                                ...
                                                name="consignee"
                                            >@if($data){{ $data->consignee }}@else{{ old('consignee') }}@endif
                                            </textarea>
                                ...
                                <div class="form-group{{ $errors->has('notify_party') ? ' has-danger' : '' }}">
                                            <textarea style="width: 100%; height: 40px" placeholder="7.notify party:  "
                                                ...
                                                name="notify_party"
                                            >@if($data){{ $data->notify_party }}@else{{ old('notify_party') }}@endif
                                            </textarea>
                            ...
                            <div class="col-md-9 form-group">
                                <select class="form-control reviewer select2" required name="request_by">
                                    ...
                                    @foreach($reviewers as $item)
                                        <option value="{{ $item->id }}" @if($item->id == @$requestBy->user_id) selected @endif>
                                            {{ $item->reviewer_name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 form-group">
                                <select class="form-control reviewer select2" name="agree_by_1">
                                    ...
                                    @foreach($reviewers as $item)
                                        <option value="{{ $item->id }}" @if($item->id == @$agreeBy1->user_id) selected @endif>
                                            {{ $item->reviewer_name }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-9 form-group">
                                <select class="form-control reviewer select2" name="agree_by_2">
                                    <option value="0"><< ជ្រើសរើស >></option>
                                    @foreach($reviewers as $item)
                                        <option value="{{ $item->id }}" @if($item->id == @$agreeBy2->user_id) selected @endif>
                                            {{ $item->reviewer_name }}
                                        </option>
                                    @endforeach
                                </select>
                       ...
                       {{-- <div class="row">
                            ...
                            <div class="col-md-9 form-group">
                                <select class="form-control select2" required @if(Auth::user()->company_id != 5) required @endif name="reviewer_by">
                                    <option value=""><< ជ្រើសរើស >></option>
                                    @foreach($reviewers as $key => $item)
                                        <option value="{{ $item->id }}" @if($item->id == @$reviewerBy->user_id) selected @endif>
                                            {{ $item->reviewer_name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-9 form-group">
                                <select class="form-control reviewer select2"  name="reviewer_sh">
                                    <option value=""><< ជ្រើសរើស >></option>
                                    @foreach($reviewers as $item)
                                        <option value="{{ @$item->id }}" @if($item->id == @$reviewerSh->user_id) selected @endif>
                                            {{ $item->reviewer_name }}
                                        </option>
                                    @endforeach
                                </select>
...
@push('js')
    ...
    <script>
        ...
        $(".company").change(function(){
            ...
            $.ajax({
                type : 'get',
                url : "{{URL::route('request_po.find_review')}}",
                data:{'company':$value},
