            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <form
                        ...
                        id="requestForm"
                        method="POST"
                        action="{{ route('send_receive.update', $data->id) }}"
                        ...
                        <div class="card ">
                            <div class="card-header card-header-primary">
                                <h4 class="card-title">{{ __('កែប្រែសំណើរប្រគល់-ទទួលសម្ភារៈ') }}</h4>
                            ...
                            <div class="card-body ">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        @include('send_receive.partials.item_table_edit')
                                    </div>
                                </div>
                                            ...
                                            <div class="col-md-10 form-group">
                                                <select class="form-control select2" name="sender" required>
                                                    ...
                                                    @foreach($staffs as $key => $value)
                                                        <option
                                                            value="{{ $value->id }}"
                                                            @if($value->id == @$sender) selected @endif
                                                        >
                                                        {{ $value->name }}
                                                    </option>
                                                    @endforeach
                                            ...
                                            <div class="col-md-10 form-group">
                                                <select class="form-control select2" name="receiver" required>
                                                    ...
                                                    @foreach($staffs as $key => $value)
                                                        <option
                                                            value="{{ $value->id }}"
                                                            @if($value->id == @$receiver) selected @endif
                                                        >
                                                            {{ $value->name }}
                                                        </option>
                                                    @endforeach
