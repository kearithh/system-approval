      ...
      <div class="row">
        <div class="col-md-12">
          <form
            ...
            <input type="hidden" class="request_token" name="request_type" value="{{ config('app.type_wave_association') }}">
            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">ទម្រង់សំណើសុំលើកលែងអត់លក់សេវាសង្រោះគ្រួសារ</h4>
                <p class="card-category"></p>
              </div>
              <div class="card-body ">
                  @include('wave_association.partials.add_more_item_table')
                <div class="row">
...
@include('wave_association.partials.add_more_js')
