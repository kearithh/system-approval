                ...
                <div class="col-md-9 col-lg-10">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h4 class="card-title "><strong>Loan Adjustment List</strong></h4>
                        </div>
                                    ...
                                    @if($data->count())
                                        ...
                                        @foreach($data as $key => $item)
                                            <tr>
                                                <td> {{ $i++ }}</td>
                                                <td class="td-actions">
                                                    @include('global.list_action', ['uri' => 'reschedule_loan', 'object' => $item, 'type' => config('app.type_reschedule_loan')])
                                                </td>
                                                ...
                                                <td>{{ @reviewer_position(\App\RescheduleLoan::reviewerNames($item->id)) }}</td>
                                                <td>{{ @approver_position(\App\RescheduleLoan::approverName($item->id)) }}</td>
