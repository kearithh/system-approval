                        ...
                        <div class=" @if(@$approved) col-md-8 col-lg-9  @else col-md-12 col-lg-12 @endif"> 
                            ...
                            <div class="card">
                                <div class="card-header card-header-primary">
                                    <h4 class="card-title "><strong>Associations List</strong></h4>
                                </div>
                                            ...
                                            @if($data->count())
                                                ...
                                                @foreach($data as $key => $item)
                                                    <tr>
                                                        <td> {{ $i++ }}</td>
                                                        <td class="td-actions">
                                                            @include('global.list_action', ['uri' => 'association', 'object' => $item, 'type' => config('app.type_association')])
                                                        </td>
                                                        ...
                                                        <td>{{ @reviewer_position(\App\Association::reviewerNames($item->id)) }}</td>
                                                        <td>{{ @approver_position(\App\Association::approverName($item->id)) }}</td>
