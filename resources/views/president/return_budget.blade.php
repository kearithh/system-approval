                        ...
                        <div class=" @if(@$approved) col-md-8 col-lg-9  @else col-md-12 col-lg-12 @endif"> 
                            ...
                            <div class="card">
                                <div class="card-header card-header-primary">
                                    <h4 class="card-title "><strong>Return Budget List</strong></h4>
                                </div>
                                            ...
                                            @if($data->count())
                                                ...
                                                @foreach($data as $key => $item)
                                                    <tr>
                                                        <td> {{ $i++ }}</td>
                                                        <td class="td-actions">
                                                            @include('global.list_action', ['uri' => 'return_budget', 'object' => $item, 'type' => config('app.type_sale_asset')])
                                                        </td>
                                                        ...
                                                        <td>{{ @reviewer_position(\App\ReturnBudget::reviewerNames($item->id)) }}</td>
                                                        <td>{{ @approver_position(\App\ReturnBudget::approverName($item->id)) }}</td>
