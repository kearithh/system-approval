                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive" style="padding: 0 10px">
                            <table class="table table-striped table-hover">
                                ...
                                <th style="min-width: 320px;">{{ __('បញ្ជាក់ដោយ') }}</th>
                                    ...
                                    @if($data->count())
                                        ...
                                        @foreach($data as $key => $item)
                                            <tr>
                                                <td> {{ $i++ }}</td>
                                                <td class="td-actions">
                                                    <a href="/mission/{{$item->request_id}}/show?menu={{ request()->segment(1) }}&type={{config('app.type_mission_item')}}" 
                                                        class="preview btn btn-xs btn-info" title="View the request">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                                                </td>
                                                ...
                                                <td>{{ @reviewer_position(\App\MissionItem::reviewerNames($item->id)) }}</td>
