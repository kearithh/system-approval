                        ...
                        <div class=" @if(@$approved) col-md-8 col-lg-9  @else col-md-12 col-lg-12 @endif"> 
                            ...
                            <div class="card">
                                <div class="card-header card-header-primary">
                                    <h4 class="card-title "><strong>Damaged Asset List</strong></h4>
                                </div>
                                    ...
                                    <table class="table table-striped table-hover">
                                        <thead class="">
                                            <tr>
                                                ...
                                                <th style="min-width: 300px; text-align: center;">ទ្រព្យសម្បត្តិខូច</th>
                                                <th style="min-width: 100px;">{{ __('សំណង') }}</th>
                                                <th style="min-width: 150px">{{ __('ស្នើរដោយ') }}</th>
                                            ...
                                            @if($data->count())
                                                ...
                                                @foreach($data as $key => $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {{ @items(\App\DamagedLog::items_name($item->id)) }}
                                                        </td>
