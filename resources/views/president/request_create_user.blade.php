                        ...
                        <div class=" @if(@$approved) col-md-8 col-lg-9  @else col-md-12 col-lg-12 @endif"> 
                            ...
                            <div class="card">
                                <div class="card-header card-header-primary">
                                    <h4 class="card-title "><strong>Request Create User List</strong></h4>
                                </div>
                                <div class="table-responsive" style="padding: 0 10px">
                                    <table class="table table-striped table-hover">
                                        <thead class="">
                                        <th style="min-width: 50px">ល.រ</th>
                                        <th style="min-width: 100px; text-align: center;">{{ __('សកម្ម') }}</th>
                                        ...
                                        <th style="min-width: 320px;">{{ __('ត្រួតពិនិត្យ និងទទួលដោយ') }}</th>
                                                ...
                                                @foreach($data as $key => $item)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="td-actions text-center">
                                                            @include('global.list_action', ['uri' => 'request_create_user', 'object' => $item, 'type' => config('app.type_request_create_user')])
                                                        </td>
                                                        <td>{{ @request_status($item) }}</td>
                                                        <td>{{ @$item->purpose }}</td>
                                                        <td>{{ @$item->requester_name }}</td>
                                                        <td>{{ @reviewer_position(\App\RequestCreateUser::reviewerName($item->id)) }}</td>
                                                        <td>{{ @approver_position(\App\RequestCreateUser::approverName($item->id)) }}</td>
