                          ...
                          <div style="float: right;">
                            <form
                              ...
                              <table>
                                ...
                                <td>
                                  <input type="text" autocomplete="off" name="date_from" placeholder="ចាប់ពី" value="{{ @$date_from }}" class="form-control form-control-sm datepicker">
                                </td>
                                <td>
                                  <input type="text" autocomplete="off" name="date_to" placeholder="ដល់" value="{{ @$date_to }}" class="form-control form-control-sm datepicker">
                                </td>
                                <td>
            ...
            $('.edit-btn').click(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        // close function change company to change department 
