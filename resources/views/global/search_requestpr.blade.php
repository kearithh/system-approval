<form role="form">
    <div class="card-body p-0">
                ...
                <div class="form-group">
                    ...
                    <select name="company_id" id="" class="form-control select2">
                        ...
                        @foreach($company as $key => $value)
                            @if(!is_array(@$company_request) || !in_array($value->id, @$company_request))
        ...
        <div class="col-sm-3">
        <div class="form-group">
            <label for="code_pr">PR Code</label>
            <select name="code_pr" id="code_pr" class="form-control select2">
                <option value="%">All</option>
                <?php $code_pr = (isset($_GET['code_pr']) ? $_GET['code_pr'] : null); ?>
